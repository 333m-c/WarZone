...
export default function Overall({realtimeDefenceData,realtimeOffenceData,defenceDaily,offenceDaily}) {
    ...
    <div className={style.container}>
        <GlobeCanvas realtimeDefenceData={realtimeDefenceData} realtimeOffenceData={realtimeOffenceData}/>
